		         ...
		         <div class="accordion-inner">
					<div class="accordion ac"id = "collapseTwo_A" ><!--accordion ac interno-->
						<div class="accordion-group">
							<div class="accordion-heading centered">
								<div class ="row">
                                    ...
                                    <div class="col-lg-4">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#collapseTwo_A" href="#collapseAllegati">
						...
						<div class="row">
                            ...
                            <div id = "collapseAllegati" class="accordion-body collapse" >
                                <div class="col-lg-12">
                                    <div class="panel panel-info">
                                        <div class="panel-body">
                                            <h3>Allegati per indagini diagnostiche</h3>
                                            <hr/>
                                            <form method = "post" action = "../files/uploadFiles.php" enctype = "multipart/form-data">
                                                <input  type = "file" name = "nomefile"/>
                                                <br>
